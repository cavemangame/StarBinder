...
namespace StarBinder.WindowsApp.NControls
{
    public class PhoneSilverlightPlatform : IPlatform
    {
        ...
        /// </summary>
        public string Name { get { return "WindowStoreApp"; } }
    ...
    public class CanvasCanvas : IImageCanvas
    {
        ...
        public void DrawPath(IEnumerable<PathOp> ops, Pen pen = null, Brush brush = null)
        {
            ...
            BindingOperations.SetBinding(pathEl, Path.DataProperty, b);
        ...
        /// <returns></returns>
        private Windows.UI.Xaml.Media.Brush GetBrush(Brush fromBrush)
        {
            ...
            var lb = fromBrush as LinearGradientBrush;
            if (lb != null)
            {
                // Linear gradient
                ...
                if (n >= 2)
                {
                    ...
                    {
                        var s = lb.Stops[i];
                        gradStops.Add(new GradientStop
                        {
            ...
            //{
            //    // Radial gradient
            //    var grad = new Windows.UI.Xaml.Media.Gra();
        ...
        /// <param name="fromBrush"></param>
        /// <returns></returns>
        private Windows.UI.Xaml.Media.Brush GetStroke(Pen fromPen)
        {
            return new SolidColorBrush(new Windows.UI.Color
            {
                A = fromPen.Color.A,
