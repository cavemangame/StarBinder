...
using NGraphics;
using Group = NGraphics.Group;

namespace StarBinder.Resources
{
    public class SvgReaderEx
    {
        readonly IFormatProvider icult = CultureInfo.InvariantCulture;
        ...
        public SvgReaderEx(System.IO.TextReader reader)
        {
