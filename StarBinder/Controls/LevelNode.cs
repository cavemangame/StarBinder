...
namespace StarBinder
{
	public class LevelNode : CCNode
	{
		...
		private void AddSprites()
		{
			...
			CCRect rect1 = Utils.GetRect(0.15f + _x * 0.235f, 1.05f - _y * 0.28f, 0.2f, 0.2f);
			if (_levelNum <= 8) rect1 = Utils.GetRect(0.15f + _x * 0.235f, 1.05f - _y * 0.28f, 0.2f, 0.2f);
			else if (_levelNum <= 10) rect1 = Utils.GetRect(0.15f + (_x + 1) * 0.235f, 1.0f - _y * 0.28f, 0.2f, 0.2f);
			...
			CCRect r2 = Utils.GetRect(0f, 0.09f, 0.175f, 0.03f);
			...
			CCRect r3 = Utils.GetRect (0f, 0f, 0.15f, 0.15f);
